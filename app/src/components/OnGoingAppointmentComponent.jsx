...
const OnGoingAppointmentComponent = () => {
  return (
    <View className="w-[335px] bg-[#FFFCF8] border-[0.75px] border-[#FFF4E5] rounded-[15px] ml-[10px] py-8">
      <View className="flex-row ml-[25px] justify-between mb-[10px]">
        <Text className="font-[Proxima-Nova-Semibold] text-[14px]">
          Booked Services - Home Visit
        </Text>
        <AntDesign name="right" size={24} color="#6319C4" />
      </View>
      <View className="flex-row item-center gap-[5px] ml-[25px] mb-[10px]">
      ...
      <View className="flex-row items-center gap-[5px] ml-[25px] mb-[10px]">
        <Text className="mt-[3px]">
